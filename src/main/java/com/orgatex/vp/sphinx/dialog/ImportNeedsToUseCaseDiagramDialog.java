...
public class ImportNeedsToUseCaseDiagramDialog extends JDialog {
    ...
    private void setupEventHandlers() {
        ...
        inputFileField.getDocument().addDocumentListener(new javax.swing.event.DocumentListener() {
            public void insertUpdate(javax.swing.event.DocumentEvent e) { updateImportButtonState(); }
            public void removeUpdate(javax.swing.event.DocumentEvent e) { updateImportButtonState(); }
            public void changedUpdate(javax.swing.event.DocumentEvent e) { updateImportButtonState(); }
        });
    ...
    private void performImport(File inputFile) {
        try {
            ...
            showSuccess("Successfully imported " + inputFile.getName() +
                       "\nCreated diagram: " + diagram.getName());
