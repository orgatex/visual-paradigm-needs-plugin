...
public class NeedsFileImporter {
    ...
    public IDiagramUIModel importFromFile(File jsonFile) throws ImportException {
        try {
            ...
            ApplicationManager.instance().getDiagramManager().layout(diagram,
                ApplicationManager.instance().getDiagramManager().LAYOUT_ORGANIC);
     ...
     */
    private void importNeeds(IDiagramUIModel diagram, NeedsFile.VersionData versionData) throws ImportException {
