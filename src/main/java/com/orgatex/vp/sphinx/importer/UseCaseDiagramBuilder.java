...
public class UseCaseDiagramBuilder {
    ...
    public IDiagramUIModel createUseCaseDiagram(String diagramName) throws Exception {
        IDiagramUIModel diagram = diagramManager.createDiagram(IDiagramTypeConstants.DIAGRAM_TYPE_USE_CASE_DIAGRAM);
     ...
     */
    public void createUseCaseElements(IDiagramUIModel diagram, Map<String, NeedsFile.Need> needs) throws Exception {
     ...
     */
    public void createRelationships(IDiagramUIModel diagram, Map<String, NeedsFile.Need> needs) throws Exception {
        ...
        for (Map.Entry<String, NeedsFile.Need> entry : needs.entrySet()) {
            ...
            relationshipCount += createAssociationRelationships(diagram, sourceId, need.getAssociatesLinks());
        }
     ...
     */
    private void createUseCaseElement(IDiagramUIModel diagram, NeedsFile.Need need, Point position) throws Exception {
     ...
     */
    private void createActorElement(IDiagramUIModel diagram, NeedsFile.Need need, Point position) throws Exception {
     ...
     * Create include relationships.
     */
    private int createIncludeRelationships(IDiagramUIModel diagram, String sourceId, String includesLinks) throws Exception {
     ...
     * Create extend relationships.
     */
    private int createExtendRelationships(IDiagramUIModel diagram, String sourceId, String extendsLinks) throws Exception {
     ...
     * Create association relationships.
     */
    private int createAssociationRelationships(IDiagramUIModel diagram, String sourceId, String associatesLinks) throws Exception {
     ...
     */
    private boolean createIncludeRelationship(IDiagramUIModel diagram, String sourceId, String targetId) throws Exception {
        ...
        if (sourceElement == null || targetElement == null || sourceModel == null || targetModel == null) {
            System.err.println("Warning: Cannot create include relationship from " + sourceId + " to " + targetId + " - elements not found");
            return false;
        }
     ...
     */
    private boolean createExtendRelationship(IDiagramUIModel diagram, String sourceId, String targetId) throws Exception {
        IDiagramElement sourceElement = createdElements.get(sourceId);
        IDiagramElement targetElement = createdElements.get(targetId);
        IModelElement sourceModel = createdModels.get(sourceId);
        IModelElement targetModel = createdModels.get(targetId);
        ...
        if (sourceElement == null || targetElement == null || sourceModel == null || targetModel == null) {
            System.err.println("Warning: Cannot create extend relationship from " + sourceId + " to " + targetId + " - elements not found");
            return false;
        }
     ...
     */
    private boolean createAssociationRelationship(IDiagramUIModel diagram, String sourceId, String targetId) throws Exception {
        IDiagramElement sourceElement = createdElements.get(sourceId);
        IDiagramElement targetElement = createdElements.get(targetId);
        IModelElement sourceModel = createdModels.get(sourceId);
        IModelElement targetModel = createdModels.get(targetId);
        ...
        if (sourceElement == null || targetElement == null || sourceModel == null || targetModel == null) {
            System.err.println("Warning: Cannot create association relationship from " + sourceId + " to " + targetId + " - elements not found");
            return false;
        }
    ...
    private void setUseCaseStatus(IUseCase useCaseModel, String status) {
        ...
        try {
            ...
            System.err.println("Warning: Could not set status '" + status + "' for use case: " + e.getMessage());
        }
    }
    ...
    private int mapStatusToVP(String status) {
        switch (status.toLowerCase()) {
            case "identify": return 0; // STATUS_IDENTIFY
            case "discuss": return 1;  // STATUS_DISCUSS
            case "elaborate": return 2; // STATUS_ELABORATE
            case "design": return 3;   // STATUS_DESIGN
            case "consent": return 4;  // STATUS_CONSENT
            case "develop": return 5;  // STATUS_DEVELOP
            case "complete": return 6; // STATUS_COMPLETE
