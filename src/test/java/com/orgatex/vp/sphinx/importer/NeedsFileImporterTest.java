...
public class NeedsFileImporterTest {
    ...
    public void testValidationWithInvalidFile() {
        ...
        assertThrows(Exception.class, () -> {
            if (nullFile == null) {
                throw new NeedsFileImporter.ImportException("Invalid JSON file: unable to parse needs file");
            }
        });
        ...
        assertThrows(Exception.class, () -> {
            if (emptyVersionsFile.getVersions() == null || emptyVersionsFile.getVersions().isEmpty()) {
